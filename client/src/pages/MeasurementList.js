...
export default function MeasurementList() {
    ...
    return (_jsxs("div", { children: [items.length === 0 ? (_jsx("div", { children: "No measurements found" })) : (_jsx("div", { className: "table-container", children: _jsxs("table", { className: "table", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "#" }), _jsx("th", { children: "Name" }), _jsx("th", { children: "Timestamp" }), _jsx("th", { children: "Duration" }), _jsx("th", { children: "Avg RSSI" }), _jsx("th", { children: "Avg PER" }), _jsx("th", { children: "Type" }), _jsx("th", { children: "Actions" })] }) }), _jsx("tbody", { children: items.map((i) => (_jsxs("tr", { children: [_jsx("td", { children: i.number }), _jsx("td", { children: i.name }), _jsx("td", { children: i.timestamp }), _jsx("td", { children: fmtDuration(i.durationSec) }), _jsxs("td", { children: [i.avgRssi, " dBm"] }), _jsxs("td", { children: [i.avgPer, "%"] }), _jsx("td", { children: i.type ?? (i.filename.includes('_continous') ? 'continous' : 'spot') }), _jsxs("td", { children: [_jsx("button", { className: "btn", onClick: () => { setView(i); setDetails(null); api.get(`/measurements/${i.filename}/details`).then((r) => setDetails(r.data)); }, children: "View" }), ' ', _jsx("button", { className: "btn btn-danger", onClick: () => setConfirm(i), children: "Delete" })] })] }, i.id))) })] }) })), _jsxs("div", { style: { marginTop: 12 }, children: [_jsx("a", { href: "#/new", children: _jsx("button", { className: "btn btn-primary", onClick: () => (window.location.href = '/new'), children: "New Measurement" }) }), _jsx("button", { className: "btn", style: { marginLeft: 8 }, onClick: () => nav('/'), children: "Back" })] }), view && (_jsx("div", { style: { position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.4)', display: 'grid', placeItems: 'center' }, children: _jsxs("div", { style: { background: 'white', padding: 16, borderRadius: 8, maxWidth: 800, width: '90%' }, children: [_jsxs("h3", { children: [view.name, " ", _jsxs("small", { style: { color: '#6b7280', fontWeight: 400 }, children: ["(", view.type ?? (view.filename.includes('_continous') ? 'continous' : 'spot'), ")"] })] }), _jsxs("p", { children: ["File: ", view.filename] }), details ? (_jsxs(_Fragment, { children: [_jsxs("div", { style: { display: 'flex', gap: 16, flexWrap: 'wrap' }, children: [_jsxs("div", { children: ["Duration: ", fmtDuration(details.stats.durationSec)] }), _jsxs("div", { children: ["Avg RSSI: ", details.stats.avgRssi, " dBm"] }), _jsxs("div", { children: ["Avg PER: ", details.stats.avgPer, "%"] })] }), _jsxs("div", { style: { marginTop: 8 }, children: [_jsx("h4", { children: "Per-device averages" }), _jsx("div", { className: "tiles", children: details.series.map((s) => {
                                                ...
                                                return (_jsxs("div", { className: "tile", children: [_jsxs("div", { className: "title", children: ["D", s.deviceId, s.tag ? ` • ${s.tag}` : ''] }), _jsxs("div", { style: { color: rssiColor }, children: ["Avg RSSI: ", avgRssi, " dBm"] }), _jsxs("div", { style: { color: perColor }, children: ["Avg PER: ", avgPer, "%"] })] }, s.deviceId));
                                            }) })] }), _jsx("div", { style: { marginTop: 8 }, children: _jsx(ChartLive, { series: details.series.map((s) => ({ id: s.deviceId, tag: s.tag, points: s.points })), markers: details.markers?.map((m) => m.ts) }) }), details.perSub && (_jsxs("div", { style: { marginTop: 12 }, children: [_jsx("h4", { children: "Average per sub-location" }), _jsx("div", { className: "table-container", children: _jsxs("table", { className: "table", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "Index" }), _jsx("th", { children: "Sub-location" }), _jsx("th", { children: "Avg RSSI" }), _jsx("th", { children: "Avg PER" }), _jsx("th", { children: "Samples" })] }) }), _jsx("tbody", { children: details.perSub.map((row) => (_jsxs("tr", { children: [_jsx("td", { children: row.subIndex }), _jsx("td", { children: row.subLocation || '' }), _jsxs("td", { children: [row.avgRssi, " dBm"] }), _jsxs("td", { children: [row.avgPer, "%"] }), _jsx("td", { children: row.samples })] }, row.subIndex))) })] }) })] }))] })) : (_jsx("div", { children: "Loading\u2026" })), _jsx("a", { href: `/api/measurements/${view.filename}`, target: "_blank", children: "Download CSV" }), _jsx("div", { style: { marginTop: 8, textAlign: 'right' }, children: _jsx("button", { className: "btn", onClick: () => { setView(null); setDetails(null); }, children: "Close" }) })] }) })), _jsx(ConfirmDialog, { open: !!confirm, title: "Confirm Delete", message: confirm ? `Delete ${confirm.filename}?` : '', onCancel: () => setConfirm(null), onConfirm: () => confirm && onDelete(confirm) })] }));
}
